...
export const tutorialSteps: TutorialStep[] = [
  ...
  },
  {
    ...
    title: '订单面板',
    content: '查看可用订单',
    description: '左侧的订单面板显示了当前可用的订单。每个订单都包含：遗物信息、客户名称、截止日期和报酬。',
    triggerType: 'auto',
  ...
  },
  {
    ...
    order: 2,
    title: '接取订单',
    content: '点击「接受」按钮接取订单',
    description: '请在左侧订单面板中选择一个订单并点击「接受」按钮。这是关键操作，必须实际完成才能继续。注意订单的截止日期，逾期未完成会损失声望。',
    triggerType: 'auto',
    actionType: 'highlight_element',
  ...
  },
  {
    ...
    triggerType: 'auto',
    actionType: 'highlight_element',
    targetSelector: '.season-entry-btn',
    position: 'top',
    canSkip: true,
    isBlocking: true
  },
  ...
  },
  {
    ...
    triggerType: 'auto',
    actionType: 'highlight_element',
    targetSelector: '.achievement-entry-btn',
    position: 'left',
    canSkip: true,
    isBlocking: true
  },
